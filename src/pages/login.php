...
<body>
    ...
    <main class="bg-[#FFF2DB] w-full mt-26 flex flex-col gap-y-3 justify-center items-center p-3">
    <?php include $_SERVER['DOCUMENT_ROOT'] . '/web-sekolah/src/components/Element/FormLogin.php'; ?>
    </main>
